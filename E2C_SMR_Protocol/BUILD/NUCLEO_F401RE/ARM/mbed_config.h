...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "DemoHotSpot"                                                                                    // set by application
#define MBED_CONF_APP_WIFI_SHIELD                                             WIFI_IDW0XX1                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "DemoHotSpot"                                                                                    // set by application
...
#define MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE                              750                                                                                              // set by application[*]
#define MBED_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE                              750                                                                                              // set by application[*]
...
#define MBED_CONF_IDW0XX1_EXPANSION_BOARD                                     IDW04A1                                                                                          // set by application[*]
...
// Macros
#define IDW04A1_WIFI_HW_BUG_WA                                                                                                                                                 // defined by application
